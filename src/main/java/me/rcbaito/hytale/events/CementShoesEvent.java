...
public class CementShoesEvent implements ChaosEvent{
    @Override
    public String getId() {
        return "cement";
    }
    @Override
    public String getName() { return "Cement Shoes"; }

    @Override
    public String getDescription() { return "The players are unable to jump."; }
